# class declaration
class CalculatePrice:  # discount in %
...
def main():
    ...
    d = CalculatePrice(10)
    # using object as function i.e. d(300) since two variables are return by call function,
    # therefore # unpack the return values in two variables
